...
switch (process.env.PUBLIC_SITE_NAME) {
	case "system":
		...
		return "git diff $CACHED_COMMIT_REF $COMMIT_REF ./packages/system/"
	case "landing":
		console.log("landing site match found, checking diff for changes")
		return "git diff $CACHED_COMMIT_REF $COMMIT_REF ./packages/landing-site/"
	case "react":
		console.log("react site match found, checking diff for changes")
		return "git diff $CACHED_COMMIT_REF $COMMIT_REF ./packages/site/src/data/react/ ./packages/site/src/components/ ./packages/site/src/layouts/ ./packages/site/src/pages/"
	case "nodejs":
		console.log("node site match found, checking diff for changes")
		return "git diff $CACHED_COMMIT_REF $COMMIT_REF ./packages/site/src/data/nodejs/ ./packages/site/src/components/ ./packages/site/src/layouts/ ./packages/site/src/pages/"
	case "graphql":
		console.log("graphql site match found, checking diff for changes")
		return "git diff $CACHED_COMMIT_REF $COMMIT_REF ./packages/site/src/data/graphql/ ./packages/site/src/components/ ./packages/site/src/layouts/ ./packages/site/src/pages/"
	case "vue":
		console.log("vue site match found, checking diff for changes")
		return "git diff $CACHED_COMMIT_REF $COMMIT_REF ./packages/site/src/data/vue/ ./packages/site/src/components/ ./packages/site/src/layouts/ ./packages/site/src/pages/"
	case "solidjs":
	...
	case "qwik":
		...
		return "git diff $CACHED_COMMIT_REF $COMMIT_REF ./packages/site/src/data/qwik/ ./packages/site/src/components/ ./packages/site/src/layouts/ ./packages/site/src/pages/"
	default:
