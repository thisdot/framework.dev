...
export const blogs: Blog<(typeof blogTags)[number]>[] = [
	...
	},
	{
		...
		author: 'Miško Hevery',
		description:
			'CTO at builderio creator of QwikDev, @angular, @angularjs, co-creator of karmajs, shares an intro to Qwik framework.',
		image:
			'https://pbs.twimg.com/profile_images/1389683812968194049/MhsEUijj_400x400.jpg',
	...
	},
	{
		...
		author: 'Miško Hevery',
		description:
			'CTO at builderio creator of QwikDev, @angular, @angularjs, co-creator of karmajs, shares an 8 series on Qwik.',
		image:
			'https://pbs.twimg.com/profile_images/1389683812968194049/MhsEUijj_400x400.jpg',
	...
	},
	{
		...
		author: 'Miško Hevery',
		description:
			'CTO at builderio creator of QwikDev, @angular, @angularjs, co-creator of karmajs, shares an update on Qwik framework.',
		image:
			'https://pbs.twimg.com/profile_images/1389683812968194049/MhsEUijj_400x400.jpg',
	...
	},
	{
		...
		author: 'Miško Hevery',
		description:
			'CTO at builderio creator of QwikDev, @angular, @angularjs, co-creator of karmajs, talks about hydration.',
		image:
			'https://pbs.twimg.com/profile_images/1389683812968194049/MhsEUijj_400x400.jpg',
	...
	},
	{
		...
		author: 'Miško Hevery',
		description:
			'CTO at builderio creator of QwikDev, @angular, @angularjs, co-creator of karmajs, talks about progressive hydration.',
		image:
			'https://pbs.twimg.com/profile_images/1389683812968194049/MhsEUijj_400x400.jpg',
	...
	},
	{
		...
		author: 'Miško Hevery',
		description:
			'CTO at builderio creator of QwikDev, @angular, @angularjs, co-creator of karmajs, compares Qwik to other framework in terms of BigO notation.',
		image:
			'https://pbs.twimg.com/profile_images/1389683812968194049/MhsEUijj_400x400.jpg',
		href: 'https://www.builder.io/blog/why-progressive-hydration-is-harder-than-you-think',
		tags: [],
	},
	{
		...
		description:
			'Brittney Postma a Developer Experience Engineer at Netlify, shares how to deploy the Qwik JavaScript framework.',
		image:
			'https://cdn.sanity.io/images/o0o2tn5x/production/a958aa065e057438555113ba30fadf4d1e6e5b9e-1594x1588.png?w=64&h=64&fit=crop&crop=entropy&auto=format',
